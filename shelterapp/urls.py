...
from .views import register, user_login,user_logout, shelter_list, create_shelter, edit_shelter, delete_shelter, CustomPasswordResetView, search_shelters, join_shelter, shelter_detail, access_denied, create_pet, edit_pet, pet_detail, add_vet_assignment, edit_vet_assignment, vet_assignment_detail
