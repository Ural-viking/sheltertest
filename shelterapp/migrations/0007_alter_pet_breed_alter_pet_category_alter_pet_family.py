# Generated by Django 5.1.4 on 2025-01-25 10:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shelterapp', '0006_alter_pet_breed'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='pet',
            name='family',
            field=models.CharField(choices=[('Кошки', 'Кошки'), ('Собаки', 'Собаки'), ('Парнокопытные', 'Парнокопытные'), ('Непарнокопытные', 'Непарнокопытные'), ('Фретка', 'Фретка'), ('Кролик', 'Кролик'), ('Грызуны', 'Грызуны'), ('Птицы', 'Птицы'), ('Псовые', 'Псовые'), ('Медвежьи', 'Медвежьи')], max_length=50),
        ),
    ]
